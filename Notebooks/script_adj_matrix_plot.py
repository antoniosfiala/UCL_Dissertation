...
def f_adj_matrix(p_df,p_col,p_index,p_contiguity_flag = 1,p_col_full = None,p_index_full = None):
    ...
    for destination in s_rep_col:
        ...
        f_df_am.loc[destination,f_neighbour_countries] = 1
...
def f_graph(p_tuples,p_uniques = None):
    ...
    nx.draw_spring(f_G, with_labels = True, font_weight = "light",node_color = "blue",edge_color = "red",node_size=100,font_size=20)
    plt.show()
